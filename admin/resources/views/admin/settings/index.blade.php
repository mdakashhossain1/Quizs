...
@php
    ...
    $cards = [
        ...
        $card('shield', 'bg-purple-50', 'text-purple-600', 'Login Captcha', 'Cloudflare Turnstile site/secret keys and on/off toggle for the admin login form.', 'admin.settings.turnstile', 'Configure Captcha', $turnstileEnabled),
    ];
