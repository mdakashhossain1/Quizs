...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">Create Category</h1>
            <p class="text-xs text-slate-400 mt-0.5">Add a new subject grouping for quizzes</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-8">
        <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                <label for="slug" class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1.5">Slug (Auto-generated if blank)</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input type="text" value="{{ old('color', '#7C3AED') }}" id="colorText" oninput="document.getElementById('color').value = this.value"
