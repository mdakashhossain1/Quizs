    ...
    <aside id="quizs-sidebar"
        ...
        <nav class="flex-1 px-3 py-4 overflow-y-auto">
            ...
            <a href="{{ route('admin.offerwall.index') }}"
               class="nav-link {{ request()->routeIs('admin.offerwall.*') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5h6m-9 0H5a2 2 0 00-2 2v13a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2h-1M9 3h6v4H9V3zm-2 9 2 2 4-4m-6 8h10"/></svg>
                Offerwall
            </a>
